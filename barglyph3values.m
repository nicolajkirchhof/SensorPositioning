function [h0 h1out] = barglyph3values(xlist,ylist,height, width,graph_data, graph_data2, xrange, yrange, graph_data3)
%%
...
%         id_clr_rev = numel(d)-idb+1;
        ...
        plot(h1, idb, data_min+(d3(idb)-data_min3)*data3_scale, 'marker', '+', 'HandleVisibility','off', 'color', 'k');
