function [ sol ] = cmcqm_nonlin( cmcq_opt, config )
%%
clear cmcqm
...
prob.options = opt;
prob.objective = @Optimization.Continuous.fitfct.cmcqm;
...
%%
solutions = Optimization.Continuous.cmcqm_nonlin(cmcq_opt, config);
% profile viewer
