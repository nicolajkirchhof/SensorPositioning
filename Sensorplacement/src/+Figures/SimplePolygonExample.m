...
mb.drawPoint(poly{1}{1}(:,[4]), 'color', 'k', 'markersize', 8, 'markerfacecolor', 'k');
...
mb.drawPoint(poly{1}{1}(:,[1,2,3,5,6]), 'color', gray*ones(1,3), 'markersize', 8, 'markerfacecolor', gray*ones(1,3));
