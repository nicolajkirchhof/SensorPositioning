...
sensorspace_uniform_position_distance = [800 500 250 150];
sensorspace_uniform_angle_distance = deg2rad([45 45/2 45/4 45/8 ]);
workspace_grid_position_distance = [800 500 250 150 ];
...
pc = processing_configuration(sprintf('irf_seminar-supd%d-wgpd%d-suad%d', supd, wgpd, round(rad2deg(suad))));
% pc.environment.file = 'res/floorplans/P1-Pool.dxf';
pc.environment.file = 'res/floorplans/IrfSeminarraumFinca_1.dxf';
