...
dirname = 'tmp/conference_room/ospqm';
...
bspqm_qscale = input;
%%
for ido = 1:numel(ospqm)
    fprintf(1, 'id = %d, sp: \n', ido);
    [ospqm{ido}.solution.sensors_selected', bspqm{ido}.solution.sensors_selected', bspqm{ido}.solution.sensors_selected']
    fprintf(1, 'id = %d, sc: \n', ido);
    [ospqm{ido}.solution.sc_selected], [bspqm{ido}.solution.sc_selected, bspqm{ido}.solution.sc_selected]
    fprintf(1, 'id = %d, time: \n', ido);
    [ospqm{ido}.solution.solvingtime, bspqm{ido}.solution.solvingtime, bspqm{ido}.solution.solvingtime]
    fprintf(1, 'id = %d, iterations: \n', ido);
    [ospqm{ido}.solution.iterations, bspqm{ido}.solution.iterations, bspqm{ido}.solution.iterations]
