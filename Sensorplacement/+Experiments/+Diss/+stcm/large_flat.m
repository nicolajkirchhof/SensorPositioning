...
%         num_sp = 0;
        ...
        gen.workdir = 'tmp/large_flat/stcm';
        ...
        output_filename = sprintf('tmp/large_flat/stcm/stcm__%d_%d.mat', num_sp, num_wpn);
...
stcm = Experiments.Diss.large_flat(num_sp, num_wpn);
