...
mb.drawPose(cmcqm_sp, 900, 'color', 0.75*ones(1,3), 'linewidth', 1, 'markersize', sm, 'marker', 'x', 'markerfacecolor', 0.5*ones(1,3));
...
fprintf('Sp: %d cmqm, %d cmcqm, %d mspqm\n', cmqm_sol.all_sp, cmcqm_sol.solutions{end-1}.discretization.num_sensors, basesolution.num_sensors);
