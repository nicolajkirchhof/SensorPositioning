function [ropt, state, fval, exitflag, output ] =  run(key, saveToFile)
...
%configFile = 'app/+QuadWalkTestbench/SimSqrtOptLh.config.yaml';
configFile = 'app/+QuadWalkTestbench/SimSqrtOptAoaTan.config.yaml';
%configFile = 'example/matlab/+WPNC_Dresden_2011/+Parameters/WPNC_Dresden_2011_SMC_Simulator.yaml';

%IHome
dataFile  = 'res\mat\SimTest0.2.mat';
%dataFile  = 'res\mat\quadWalkTestbench30Sample0.3Std.mat';
%dataFile  ='\\ds9\Measurements\Experiments\2011-03-15-WPNC-CricketIR\Scene=run14.txt&Freq=15&Calibrate=2.mat';
