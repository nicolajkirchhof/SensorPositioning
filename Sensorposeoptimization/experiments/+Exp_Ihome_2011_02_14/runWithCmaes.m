...
configFile = 'app/+Exp_Ihome_2011_02_14/CmaesAoa.yaml';
...
P = ropt.getProblemStructCmaes;

[xmin, fmin, counteval, stopflag, out, bestever ] = Filter.Optimization.solver.cmaes(ropt.objective, ropt.x0, [], P );
