...
pixel_values_normalized_all = cell(num_sensors, num_measures);
...
for idx_sensor = 1:num_sensors
    for idx_measure = 1:num_measures
        ...
        pixel_values_normalized_all{idx_sensor, idx_measure} = npv_extractors{idx_sensor}.apply(pixel_values_json{idx_sensor}{idx_measure});
    end
end
