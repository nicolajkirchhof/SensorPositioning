function [pixel_values_normalized, aoas, pixel_values] = extractNormalizedPixvalsAndAoas()
p = mfilename('fullpath');
p = fileparts(p);
num_labs = 8;
% p = 'app/+Exp_Labor_2011_06_21';
%%
thiloConfigFile = [p '/ThiloConfig.yaml'];
dataFile  =[p '/Exp_Labor_2011_06_21.mat'];

config = Tools.Parser.parseYaml({thiloConfigFile});
