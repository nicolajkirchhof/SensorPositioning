...
namespace VisiLibity
{
  ...
  public:
    ...
    //void snap_to_vertices_of(const Polygon& polygon_temp,
			 //    double epsilon=0.0);
	// changed to return true if succeeded by nico
    bool snap_to_vertices_of(const Polygon& polygon_temp,
			     double epsilon=0.0);
    ...
    //void snap_to_vertices_of(const Environment& environment_temp,
			 //    double epsilon=0.0);
	// changed to return true if succeeded by nico
    bool snap_to_vertices_of(const Environment& environment_temp,
			     double epsilon=0.0);
    ...
    /*void snap_to_boundary_of(const Polygon& polygon_temp,
			     double epsilon=0.0);*/
	// changed to return true if succeeded by nico
    bool snap_to_boundary_of(const Polygon& polygon_temp,
			     double epsilon=0.0);
    /** \brief relocate to closest Point on boundary if w/in \a epsilon
    ...
    /*void snap_to_boundary_of(const Environment& environment_temp,
			     double epsilon=0.0);*/
	// changed to return true if succeeded by nico
    bool snap_to_boundary_of(const Environment& environment_temp,
			     double epsilon=0.0);
  ...
  private:
	...
	// -- new code
	// both xing are zero
	//else if ( e1->first.range() <= e2->first.range() )
	//  return false;
	//else //if ( e1->first.range() > e2->first.range() )
	//	return true;
      }
